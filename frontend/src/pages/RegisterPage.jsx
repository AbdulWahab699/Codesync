...
import { useNavigate } from 'react-router-dom'; // Added for routing hook
...
function RegisterPage({ onRegister }) {
  ...
  return (
    <div style={{ background: '#080808', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontFamily: 'sans-serif', padding: '1rem', position: 'relative', overflow: 'hidden' }}>
      ...
      {/* Floating Home Route Button — Using native SPA router hook */}
      <motion.button
        onClick={() => navigate("/")}
      ...
      >
        ...
        <p style={{ color: 'rgba(255,255,255,0.45)', textAlign: 'center', fontSize: '14px', lineHeight: 1.5, marginBottom: '2rem' }}>
          Join CodeSync to establish synchronized rooms, share workspaces, and run dynamic scripts.
        </p>
        ...
        <motion.div variants={containerStagger} initial="hidden" animate="visible">
          ...
          <motion.div variants={fadeUp} style={{ marginBottom: '1.25rem' }}>
            <label style={{ display: 'block', color: 'rgba(255,255,255,0.6)', fontSize: '12px', fontWeight: 500, marginBottom: '0.5rem' }}>Username</label>
            <motion.input
          ...
          {/* Fixed bottom routing link to use single page application routing */}
